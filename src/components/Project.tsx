...
{/* Buttons */}
      ...
      <button className="flex items-center mx-2 py-2 px-4 rounded-full text-white border border-gray-900 bg-gray-900 hover:shadow-xl transition-all ease-in ease-out">
        <span className="mx-2">View</span>
        <svg fill="none" height="20" viewBox="0 0 48 48" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m0 0h48v48h-48z" fill="#fff" fill-opacity=".01"/><g stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4"><path d="m41.9999 24h-35.99998"/><path d="m30 12 12 12-12 12"/></g></svg>
      </button>
