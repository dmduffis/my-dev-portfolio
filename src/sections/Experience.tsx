...
function Experience() {
  return (
        ...
        <li className='flex flex-wrap justify-between'>
            ...
            <p className='mt-1 text-lg font-light text-left text-gray-200'>Current</p>
        </li>
        <li className='flex flex-wrap justify-between'>
        ...
        <li className='flex flex-wrap justify-between'>
            <p className='flex flex-col mt-1 text-lg font-semibold text-left text-gray-200'><span>Freelance Graphic Designer</span><span className='font-light text-base'>MVizion Design</span></p>
...
{/* Buttons */}
        ...
        <button className="flex items-center mr-2 py-2 px-1 border rounded-full hover:shadow-xl bg-white border-gray-300 text-gray-900 transition-all ease-in">
