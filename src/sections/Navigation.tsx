              ...
              <div id={open? 'open' : 'hidden'} className='navigation-links max-md:mt-6 max-md:h-full'>
                  ...
                  <span className='max-md:ml-10'>Contact</span>
                    ...
                    <li className='max-md:hover:bg-purple-900 max-md:w-screen max-md:py-4'>
                          <Link to="https://www.dropbox.com/scl/fi/3bbju85jxah8vqj2t7pam/Daniel-Duffis-Tech-Resume-2024.pdf?rlkey=7rqf22gyj0i7fdiadojctdp5y&st=2nxmt71w&dl=0" target='_blank' className="flex items-center md:mx-2 md:py-2 md:px-4 md:rounded-full text-white  md:bg-gradient-to-r from-purple-600 to-blue-600 transition-all ease-in ease-out">
